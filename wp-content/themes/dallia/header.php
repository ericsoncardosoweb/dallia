	...
	<?php if( !is_page_template('page-templates/blank-page-template.php') ): ?>
		...
		<header class="ts-header <?php echo esc_attr(implode(' ', $header_classes)); ?>">
			<div class="header-container">
				...
				?>
				<div class="header-template header-<?php echo esc_attr($smof_data['ts_header_layout']); ?> <?php echo has_nav_menu( 'vertical' )?'has-vertical-menu':''; ?> <?php echo esc_attr(implode(' ', $extra_class)); ?>">
					...
					<div class="header-middle">
						<div class="container">
							...
							<div class="search-wrapper"><?php ts_get_search_form_by_category(); ?></div>
							<?php endif; ?>
							
							<?php if( $smof_data['ts_enable_tiny_shopping_cart'] ): ?>
							<div class="shopping-cart-wrapper hidden-sticky"><?php echo ts_tiny_cart(); ?></div>
							<?php endif; ?>
						</div>
					</div>
									...
									<?php 
										if ( has_nav_menu( 'vertical' ) ) {
											...
											<div class="vertical-menu-wrapper">
												<div class="vertical-menu-heading"><?php echo ts_get_vertical_menu_heading(); ?></div>
												<?php
												wp_nav_menu( array( 'container' => 'nav', 'container_class' => 'vertical-menu pc-menu ts-mega-menu-wrapper','theme_location' => 'vertical','walker' => new TS_Walker_Nav_Menu() ) );
												?>
											</div>
											<?php
										}
