...
<div class="page-container <?php echo esc_attr($extra_class) ?>">
	...
	<?php if( $page_column_class['left_sidebar'] ): ?>
		...
		<?php if( is_active_sidebar($smof_data['ts_prod_cat_left_sidebar']) ): ?>
			<?php dynamic_sidebar( $smof_data['ts_prod_cat_left_sidebar'] ); ?>
		<?php endif; ?>
		</aside>
	<?php endif; ?>	
	...
	<div id="main-content" class="<?php echo esc_attr($page_column_class['main_class']); ?>">	
		...
		<?php if ( have_posts() ) : ?>
			...
			if( absint($smof_data['ts_prod_cat_columns']) > 0 ){
				$woocommerce_loop['columns'] = absint($smof_data['ts_prod_cat_columns']);
			}
			?>
	...
	<?php if( $page_column_class['right_sidebar'] ): ?>
		...
		<?php if( is_active_sidebar($smof_data['ts_prod_cat_right_sidebar']) ): ?>
			<?php dynamic_sidebar( $smof_data['ts_prod_cat_right_sidebar'] ); ?>
		<?php endif; ?>
		</aside>
	<?php endif; ?>	
