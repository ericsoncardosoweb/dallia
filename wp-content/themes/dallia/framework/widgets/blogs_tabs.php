<?php
add_action('widgets_init', 'ts_blogs_tabs_load_widgets');

function ts_blogs_tabs_load_widgets()
{
	register_widget('TS_Blogs_Tabs_Widget');
}

if( !class_exists('TS_Blogs_Tabs_Widget') ){
	class TS_Blogs_Tabs_Widget extends WP_Widget {

		function TS_Blogs_Tabs_Widget() {
			$widgetOps = array('classname' => 'ts-blogs-tabs-widget', 'description' => esc_html__('Display popular and recent blogs in tabs', 'gon'));
			parent::__construct('ts_blogs_tabs', esc_html__('TS - Blogs Tabs', 'gon'), $widgetOps);
		}
		...
		function widget( $args, $instance ) {
			...
			$shortcode_html = '';
			$shortcode_html .= '[vc_tta_tabs ts_style="top_border"]';
			$shortcode_html .= '[vc_tta_section title="'.$popular_title.'" tab_id="ts-popular-tab-'.rand().'"]'.$popular_tab_content.'[/vc_tta_section]';
			$shortcode_html .= '[vc_tta_section title="'.$recent_title.'" tab_id="ts-recent-tab-'.rand().'"]'.$recent_tab_content.'[/vc_tta_section]';
				...
				?>
						...
						<li>
							...
							<div class="blog-info">
								...
								<?php if( $show_excerpt ): ?>
									<div class="excerpt">
										<?php ts_the_excerpt_max_words($excerpt_words, $post); ?>
									</div>
								<?php endif; ?>
		...
		?>
			<p>
				<label for="<?php echo $this->get_field_id('popular_title'); ?>"><?php esc_html_e('Popular tab title', 'gon'); ?> </label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('recent_title'); ?>"><?php esc_html_e('Recent tab title', 'gon'); ?> </label>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_thumbnail'); ?>"><?php esc_html_e('Show post thumbnail', 'gon'); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_title'); ?>"><?php esc_html_e('Show post title', 'gon'); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_date'); ?>"><?php esc_html_e('Show post date', 'gon'); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_author'); ?>"><?php esc_html_e('Show post author', 'gon'); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_comment'); ?>"><?php esc_html_e('Show post comment', 'gon'); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_excerpt'); ?>"><?php esc_html_e('Show post excerpt', 'gon'); ?></label>
			</p>
			
			<p>
				<label for="<?php echo $this->get_field_id('excerpt_words'); ?>"><?php esc_html_e('Number of words in excerpt', 'gon'); ?> </label>
