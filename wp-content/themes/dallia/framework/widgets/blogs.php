...
if( !class_exists('TS_Blogs_Widget') ){
	class TS_Blogs_Widget extends WP_Widget {
		...
		function TS_Blogs_Widget() {
			$widgetOps = array('classname' => 'ts-blogs-widget', 'description' => esc_html__('Display blogs on site', 'gon'));
			parent::__construct('ts_blogs', esc_html__('TS - Blogs', 'gon'), $widgetOps);
		}
		...
		?>
			...
			<p>
				...
				<select class="widefat" id="<?php echo $this->get_field_id('orderby'); ?>" name="<?php echo $this->get_field_name('orderby'); ?>">
					<option value="none" <?php selected('none', $instance['orderby']) ?>>None</option>
