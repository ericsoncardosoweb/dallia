...
if( !class_exists('TS_Recent_Comments_Widget') ){
	class TS_Recent_Comments_Widget extends WP_Widget {
		...
		function TS_Recent_Comments_Widget() {
			$widgetOps = array('classname' => 'ts-recent-comments-widget', 'description' => esc_html__('Display recent comments on site', 'gon'));
			parent::__construct('ts_recent_comments', esc_html__('TS - Recent Comments', 'gon'), $widgetOps);
		}
					...
					<?php foreach( (array) $comments as $comment ): $GLOBALS['comment'] = $comment; ?>
						...
						<?php endif; ?>
							<li>
								...
								<?php if( $show_comment ): ?>
								<blockquote class="comment-body"><?php echo ts_string_limit_words(wp_strip_all_tags(get_comment_text()), 15); ?></blockquote>
								<?php endif; ?>
							</li>
		...
		function form( $instance ) {
			...
			$post_types = array_merge(array('all'=>esc_html__('All Posts', 'gon')), $post_types);
		...
		?>
			...
			<p>
				<label for="<?php echo $this->get_field_id('post_type'); ?>"><?php echo esc_html_e('Post type', 'gon'); ?> </label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('limit'); ?>"><?php esc_html_e('Number of comments to show', 'gon'); ?> </label>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_avatar'); ?>"><?php esc_html_e('Show avatar', 'gon'); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_date'); ?>"><?php esc_html_e('Show comment date', 'gon'); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_author'); ?>"><?php esc_html_e('Show comment author', 'gon'); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_comment'); ?>"><?php esc_html_e('Show comment content', 'gon'); ?></label>
			</p>
