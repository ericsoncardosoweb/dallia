			...
			switch( $option['type'] ){
				...
				case 'upload':
					...
					$html .= '<div class="ts-meta-box-field">';
						...
						$html .= '<div class="field">';
							...
							$html .= '<input type="button" class="ts_meta_box_upload_button" value="Select Image" />';
							$html .= '<input type="button" class="ts_meta_box_clear_image_button" value="Clear Image" '.($post_meta_value?'':'disabled').' />';
						if( strlen($option['desc']) > 0 ){
							$html .= '<p class="description">'.$option['desc'].'</p>';
						}
						if( $post_meta_value ){
				...
				case 'gallery':
					...
					$html .= '<div class="ts-meta-box-field ts-gallery-box">';
						...
						$html .= '<a href="#" class="add-image">Add Images</a>';
					$html .= '</div>';
				break;
