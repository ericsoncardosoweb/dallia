...
if( !class_exists('TS_Grid_List') && ts_has_woocommerce() ){
	class TS_Grid_List{
		function __construct(){
			...
			$this->settings = array(
				array(
					'name' => esc_html__( 'Default catalog view', 'gon' ),
					'type' => 'title',
					'id' => 'ts_glt_options'
				),
				array(
					'name' 		=> esc_html__( 'Catalog view', 'gon' ),
					'desc_tip' 	=> '',
					'id' 		=> 'ts_enable_glt',
					'type' 		=> 'checkbox',
					'desc' 		=> esc_html__('Display option to show product in grid or list view', 'gon'),
					'default' 	=> 'yes'
				),
				array(
					'name' 		=> esc_html__( 'Default catalog view', 'gon' ),
					'desc_tip' 	=> esc_html__( 'Display products in grid or list view by default', 'gon' ),
					'id' 		=> 'ts_glt_default',
					'type' 		=> 'select',
					'options' 	=> array(
						'grid'  => esc_html__('Grid', 'gon'),
						'list' 	=> esc_html__('List', 'gon')
					)
				),
		...
		function gridlist_toggle_button() {
			?>
				<nav class="gridlist-toggle">
					<a href="#" id="grid" title="<?php esc_html_e('Grid view', 'gon'); ?>">&#8862; <span><?php esc_html_e('Grid view', 'gon'); ?></span></a><a href="#" id="list" title="<?php esc_html_e('List view', 'gon'); ?>">&#8863; <span><?php esc_html_e('List view', 'gon'); ?></span></a>
				</nav>
			<?php
		}
